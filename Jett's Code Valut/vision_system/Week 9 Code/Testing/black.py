...
pixel_width = [125000, 53000, 40000, 26000, 21000, 16000, 13000]

# Define lower and upper bounds for Black color in HSV
lower_bound = np.array([0, 0, 0])
upper_bound = np.array([179, 255, 70])
    ...
    if frame_blob_centroids:
        ...
        for contour in contours:
            ...
            if area >= min_blob_area:
                ...
                estimated_distance = pixel_to_distance(blob_width)
        ...
        cv2.putText(frame, f'Modified Center: ({frame_centroid_x}, {frame_centroid_y})', (10, 60),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.4, (0, 255, 0), 2)

    # Display the count of detected circular black blobs
    cv2.putText(frame, f'Aisle Count: {circular_blob_count}', (10, 30), cv2.FONT_HERSHEY_SIMPLEX, 0.4, (0, 255, 0), 2)
